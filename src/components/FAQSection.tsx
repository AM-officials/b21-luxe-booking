...
const faqs: FAQ[] = [
  ...
  { q: 'Are your hair & skin products safe for Indian hair and skin?', a: 'Absolutely. We use only certified, dermatologist-approved hair and skin products at both our salons. This ensures every facial, hair spa or beauty treatment is safe, gentle and effective.' },
